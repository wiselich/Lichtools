...
class WLT_OT_set_color(bpy.types.Operator):
    bl_idname = "wlt.set_color"
    bl_label = "WLT Set Theme Color"
...
class WLT_OT_store_wire_color(bpy.types.Operator):
    bl_idname = "wlt.store_wire_color"
    bl_label = "WLT Store Wire Color"
    bl_description = "Currently toggles the viewport wireframe colors"
    bl_options = {'REGISTER', 'UNDO'}
