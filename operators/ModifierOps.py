...
from ..singletons import GM as gizmo_manager
...
class WLT_OT_AddModifier(bpy.types.Operator):
    """Edit Mode Context menu for out-of-mode objects"""
    bl_idname = "wlt.add_modifier"
    bl_label = "WLT Add Modifier"
    ...
    def invoke(self, context, event):
        ...
        if self.do_modal:
            context.area.header_text_set("In WLT Modifier Modal")
...
class WLT_OT_Modifier_Pie(bpy.types.Operator):
    """Edit Mode Context menu for out-of-mode objects"""
    bl_idname = "wlt.mod_pie"
    bl_label = "WLT Modifier Pie"
...
class WLT_OT_Modifier_UI(bpy.types.Operator):
    """Edit Mode Context menu for out-of-mode objects"""
    bl_idname = "wlt.show_mod_buttons"
    bl_label = "WLT Modifier Interface"
    bl_description = "Toggles a bunch of funky gizmo button things"

    def execute(self, context):
        gizmo_manager.toggle_temp("WLT_screen_gizmo")
        return {'FINISHED'}
