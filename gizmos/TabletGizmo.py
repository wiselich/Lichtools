...
class WLT_TabletGizmoGroup(GizmoGroup):
    bl_idname = "WLT_TG_GG"
    ...
    def poll(cls, context):
        if bpy.context.workspace.WLT.modal_state.tablet_modal:
            if isModalRunning():
                return True
    ...
    def setup(self, context):
        ...
        op = button_a.target_set_operator("wlt.context_op")
