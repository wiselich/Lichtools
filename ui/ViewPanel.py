...
class WLT_MT_MeshShadingMenu(bpy.types.Menu):
    bl_idname = "WLT_MT_MeshShadingMenu"
    bl_label = "Shading"
...
class WLT_MT_MiscOverlaysMenu(bpy.types.Menu):
    bl_idname = "WLT_MT_MiscOverlaysMenu"
...
class WLT_PT_MiscOverlaysPanel(View3DPanel_hidden, bpy.types.Panel):
    bl_idname = "WLT_PT_MiscOverlaysPanel"
...
class WLT_PT_ViewOverlaysPanel(View3DPanel, bpy.types.Panel):
    bl_idname = "WLT_PT_ViewOverlaysPanel"
    bl_label = "Overlays"
    ...
    def draw(self, context):
        ...
        overlay = context.space_data.overlay
        shading = WLT_PT_ViewOverlaysPanel.get_shading(context)
        ...
        op.name = "WLT_PT_MiscOverlaysPanel"
        ...
        if active_obj and active_obj.type == 'MESH':
            ...
            if active_mesh.use_auto_smooth:
                ...
                row.menu("WLT_MT_MeshShadingMenu")
...
class WLT_PT_quick_operators(View3DPanel, bpy.types.Panel):
    bl_idname = "WLT_PT_quick_operators"
    bl_label = "Menu Panel"

    def draw(self, context):
        layout = self.layout
        wm = bpy.context.window_manager
        qm_props = context.workspace.WLT
...
OUT = [
    WLT_PT_ViewOverlaysPanel,
    WLT_MT_MeshShadingMenu,
    WLT_MT_MiscOverlaysMenu,
    WLT_PT_MiscOverlaysPanel,
]