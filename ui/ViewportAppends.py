...
def popover(self, context):
    ...
    op.def_panel = 'VIEW3D_PT_meta_panel'
    op.alt_panel = 'VIEW3D_PT_view3d_fast_panel'


def custom_popovers(self, context):

    panel_1 = context.workspace.WLT.popovers.popover_1
    panel_2 = context.workspace.WLT.popovers.popover_2
    panel_3 = context.workspace.WLT.popovers.popover_3

    layout = self.layout
    root = layout.row(align=True)

    if panel_1 == "BATMAN":
        root.operator("wlt.set_custom_pop", text="", icon='ADD').button = 1
    else:
        root.popover(
            panel_1,
            text="",
    ...
    if panel_2 == "BATMAN":
        root.operator("wlt.set_custom_pop", text="", icon='ADD').button = 2
    else:
        root.popover(
            panel_2,
            text="",
    ...
    if panel_3 == "BATMAN":
        root.operator("wlt.set_custom_pop", text="", icon='ADD').button = 3
    else:
        root.popover(
            panel_3,
            text="",
    ...
    root.operator("wlt.clear_custom_pop", text="", icon='REMOVE')
